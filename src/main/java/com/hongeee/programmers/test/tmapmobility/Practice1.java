...
public class Practice1 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(Arrays.equals(s.solution(new int[][] {{1, 4}, {3, 4}, {3, 10}}), (new int[] {1, 10})));
    System.out.println(Arrays.equals(s.solution(new int[][] {{1, 1}, {2, 2}, {1, 2}}), (new int[] {2, 1})));
  }
