...
public class SkillTree {
	...
	public int solution(String skill, String[] skill_trees) {
		...
		for (String skillTree : skill_trees) {
			...
			for (char c : skillTree.toCharArray()) {
				...
				// 배워야 할 스킬 순서와 상관 없는 스킬이라면 skip
				if (skill.indexOf(c) == -1) {
					continue;
				}
				
				// 현재 배울 수 있는 스킬이 아닌 경우
	...
	/**
	 * Array.asList, Iterator와 정규식을 이용한 풀이법(퍼옴)
	 * 
	 * @param skill
	 * @param skill_trees
	 * @return
	 */
	public int otherSolution(String skill, String[] skill_trees) {
		int answer = 0;
